...
public class Calcula_daños_viento extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Calcula_daños_viento frame = new Calcula_daños_viento();
